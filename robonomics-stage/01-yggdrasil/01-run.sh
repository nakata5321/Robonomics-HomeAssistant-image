...
on_chroot << EOF
    ...
    curl -O https://raw.githubusercontent.com/nakata321/robonomics-hass-utils/main/raspberry_pi/configuration_first_start.sh
    curl -O https://raw.githubusercontent.com/nakata321/robonomics-hass-utils/main/raspberry_pi/input.json
