...
WantedBy=multi-user.target
  ...
  wget https://github.com/airalab/homeassistant-robonomics-integration/archive/refs/tags/1.7.0.zip &&
  unzip 1.7.0.zip &&
  mv homeassistant-robonomics-integration-1.7.0/custom_components/robonomics . &&
  rm -r homeassistant-robonomics-integration-1.7.0 &&
  rm 1.7.0.zip "
