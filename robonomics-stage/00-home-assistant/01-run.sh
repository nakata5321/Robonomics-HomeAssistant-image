...
on_chroot << EOF
    ...
    su homeassistant -c bash -c "source bin/activate && pip3 install sqlalchemy~=2.0.15 fnvhash~=0.1.0 aiodiscover~=1.4.16 webrtcvad~=2.0.10 numpy git+https://github.com/boto/botocore"

    su homeassistant -c bash -c "source bin/activate && pip3 install homeassistant==2023.11.1 psutil-home-assistant~=0.0.1 universal-silabs-flasher==0.0.14"
